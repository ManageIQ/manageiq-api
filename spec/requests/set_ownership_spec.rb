...
describe "Set Ownership" do
  ...
  context "Service set_ownership action" do
    ...
    it "to an invalid service" do
      ...
      post(api_service_url(nil, 999_999), gen_request(:set_ownership, "owner" => {"id" => 1}))
    ...
    it "without appropriate action role" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership, "owner" => {"id" => 1}))
    ...
    it "with missing owner or group" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership))
    ...
    it "with invalid owner" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership, "owner" => {"id" => 999_999}))
    ...
    it "to a service" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership, "owner" => {"userid" => api_config(:user)}))
    ...
    it "by owner name to a service" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership, "owner" => {"name" => @user.name}))
    ...
    it "by owner href to a service" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership, "owner" => {"href" => api_user_url(nil, @user)}))
    ...
    it "by owner id to a service" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership, "owner" => {"id" => @user.id}))
    ...
    it "by group id to a service" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership, "group" => {"id" => @group.id}))
    ...
    it "by group description to a service" do
      ...
      post(api_service_url(nil, svc), gen_request(:set_ownership, "group" => {"description" => @group.description}))
    ...
    it "to multiple services" do
      ...
      post(api_services_url, gen_request(:set_ownership, {"owner" => {"userid" => api_config(:user)}}, *svc_urls))
  ...
  context "Vms set_ownership action" do
    ...
    it "to an invalid vm" do
      ...
      post(api_vm_url(nil, 999_999), gen_request(:set_ownership, "owner" => {"id" => 1}))
    ...
    it "without appropriate action role" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership, "owner" => {"id" => 1}))
    ...
    it "with missing owner or group" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership))
    ...
    it "with invalid owner" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership, "owner" => {"id" => 999_999}))
    ...
    it "to a vm" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership, "owner" => {"userid" => api_config(:user)}))
    ...
    it "by owner name to a vm" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership, "owner" => {"name" => @user.name}))
    ...
    it "by owner href to a vm" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership, "owner" => {"href" => api_user_url(nil, @user)}))
    ...
    it "by owner id to a vm" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership, "owner" => {"id" => @user.id}))
    ...
    it "by group id to a vm" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership, "group" => {"id" => @group.id}))
    ...
    it "by group description to a vm" do
      ...
      post(api_vm_url(nil, vm), gen_request(:set_ownership, "group" => {"description" => @group.description}))
    ...
    it "to multiple vms" do
      ...
      post(api_vms_url, gen_request(:set_ownership, {"owner" => {"userid" => api_config(:user)}}, *vm_urls))
  ...
  context "Template set_ownership action" do
    ...
    it "to an invalid template" do
      ...
      post(api_template_url(nil, 999_999), gen_request(:set_ownership, "owner" => {"id" => 1}))
    ...
    it "without appropriate action role" do
      ...
      post(api_template_url(nil, template), gen_request(:set_ownership, "owner" => {"id" => 1}))
    ...
    it "with missing owner or group" do
      ...
      post(api_template_url(nil, template), gen_request(:set_ownership))
    ...
    it "with invalid owner" do
      ...
      post(api_template_url(nil, template), gen_request(:set_ownership, "owner" => {"id" => 999_999}))
    ...
    it "to a template" do
      ...
      post(api_template_url(nil, template), gen_request(:set_ownership, "owner" => {"userid" => api_config(:user)}))
    ...
    it "by owner name to a template" do
      ...
      post(api_template_url(nil, template), gen_request(:set_ownership, "owner" => {"name" => @user.name}))
    ...
    it "by owner href to a template" do
      ...
      post(api_template_url(nil, template), gen_request(:set_ownership, "owner" => {"href" => api_user_url(nil, @user)}))
    ...
    it "by owner id to a template" do
      ...
      post(api_template_url(nil, template), gen_request(:set_ownership, "owner" => {"id" => @user.id}))
    ...
    it "by group id to a template" do
      ...
      post(api_template_url(nil, template), gen_request(:set_ownership, "group" => {"id" => @group.id}))
    ...
    it "to multiple templates" do
      ...
      post(api_templates_url, gen_request(:set_ownership, {"owner" => {"userid" => api_config(:user)}}, *template_urls))
