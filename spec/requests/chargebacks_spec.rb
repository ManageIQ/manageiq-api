RSpec.describe "chargebacks API" do
  ...
  context "with an appropriate role" do
    ...
    it "can edit a chargeback rate through POST" do
      ...
      post api_chargeback_url(nil, chargeback_rate), gen_request(:edit, :description => "chargeback_1")
    ...
    it "can edit a chargeback rate through PATCH" do
      ...
      api_basic_authorize action_identifier(:chargebacks, :edit)
      patch api_chargeback_url(nil, chargeback_rate), [{:action => "edit",
                                                       :path   => "description",
                                                       :value  => "chargeback_1"}]
    ...
    it "can delete a chargeback rate through POST" do
      ...
      expect do
        post api_chargeback_url(nil, chargeback_rate), :action => "delete"
      end.to change(ChargebackRate, :count).by(-1)
      expect(response).to have_http_status(:ok)
    end
    ...
    it "can edit a chargeback rate detail through POST" do
      ...
      post api_rate_url(nil, chargeback_rate_detail), gen_request(:edit, :description => "rate_1")
    ...
    it "can edit a chargeback rate detail through PATCH" do
      ...
      api_basic_authorize action_identifier(:rates, :edit)
      patch api_rate_url(nil, chargeback_rate_detail), [{:action => "edit", :path => "description", :value => "rate_1"}]
    ...
    it "can delete a chargeback rate detail through POST" do
      ...
      expect do
        post api_rate_url(nil, chargeback_rate_detail), :action => "delete"
      end.to change(ChargebackRateDetail, :count).by(-1)
      expect(response).to have_http_status(:ok)
    end
  end
  ...
  context "without an appropriate role" do
    it "cannot create a chargeback rate" do
      ...
      expect { post api_chargebacks_url, :description => "chargeback_0" }.not_to change(ChargebackRate,
                                                                                        :count)
    ...
    it "cannot create a chargeback rate detail" do
      ...
      expect { post api_rates_url, :description => "rate_0", :enabled => true }.not_to change(ChargebackRateDetail,
                                                                                              :count)
      expect(response).to have_http_status(:forbidden)
    end
    ...
    it "cannot edit a chargeback rate detail" do
      ...
      expect do
        post api_rate_url(nil, chargeback_rate_detail), gen_request(:edit, :description => "rate_2")
