...
describe "Services API" do
  ...
  describe "Services create" do
    it "rejects requests without appropriate role" do
      ...
      post(api_services_url, gen_request(:create, "name" => "svc_new_1"))
    ...
    it "supports creates of multiple resources" do
      ...
      expect do
        post(api_services_url, gen_request(:create,
                                           [{"name" => "svc_new_1"},
                                            {"name" => "svc_new_2"}]))
  ...
  describe "Services edit" do
    it "rejects requests without appropriate role" do
      ...
      post(api_service_url(nil, svc), gen_request(:edit, "name" => "sample service"))
    ...
    it "supports edits of single resource" do
      ...
      post(api_service_url(nil, svc), gen_request(:edit, "name" => "updated svc1"))
    ...
    it 'accepts reference signature hrefs' do
      ...
      post(api_service_url(nil, svc_orchestration), resource)
    ...
    it "supports edits of single resource via PUT" do
      ...
      put(api_service_url(nil, svc), "name" => "updated svc1")
    ...
    it "supports edits of single resource via PATCH" do
      ...
      patch(api_service_url(nil, svc), [{"action" => "edit",   "path" => "name", "value" => "updated svc1"},
    ...
    it "supports edits of multiple resources" do
      ...
      post(api_services_url, gen_request(:edit,
  ...
  describe "Services delete" do
    it "rejects POST delete requests without appropriate role" do
      ...
      post(api_services_url, gen_request(:delete, "href" => api_service_url(nil, 100)))
    ...
    it "can be deleted via POST with an appropriate role" do
      ...
      expect do
        post(api_service_url(nil, service), :action => "delete")
      end.to change(Service, :count).by(-1)
    ...
    it "supports multiple resource deletes" do
      ...
      post(api_services_url, gen_request(:delete,
  ...
  describe "Services retirement" do
    ...
    it "rejects requests without appropriate role" do
      ...
      post(api_service_url(nil, 100), gen_request(:retire))
    ...
    it "rejects multiple requests without appropriate role" do
      ...
      post(api_services_url, gen_request(:retire, [{"href" => api_service_url(nil, 1)}, {"href" => api_service_url(nil, 2)}]))
    ...
    it "supports single service retirement now" do
      ...
      post(api_service_url(nil, svc), gen_request(:retire))
    ...
    it "supports single service retirement in future" do
      ...
      post(api_service_url(nil, svc), gen_request(:retire, "date" => ret_date, "warn" => 2))
    ...
    it "supports multiple service retirement now" do
      ...
      post(api_services_url, gen_request(:retire,
                                             [{"href" => api_service_url(nil, svc1)},
                                              {"href" => api_service_url(nil, svc2)}]))
  ...
  describe "Service reconfiguration" do
    ...
    it "rejects requests without appropriate role" do
      ...
      post(api_service_url(nil, 100), gen_request(:reconfigure))
    ...
    it "accepts action when service is reconfigurable" do
      ...
      post(api_service_url(nil, svc1), gen_request(:reconfigure, "text1" => "updated_text"))
  ...
  describe "Services" do
    ...
    it "supports expansion of virtual attributes" do
      get api_services_url, :expand => "resources", :attributes => "power_states"
    ...
    it "can query vms as subcollection via expand" do
      get api_service_url(nil, svc1), :expand => "vms"

      expect_svc_with_vms
    end

    it "can query vms as subcollection via expand with additional virtual attributes" do
      get api_service_url(nil, svc1), :expand => "vms", :attributes => "vms.cpu_total_cores"
    ...
    it "can query vms as subcollection via decorators with additional decorators" do
      get api_service_url(nil, svc1), :expand => "vms", :attributes => "", :decorators => "vms.supports_console?"
    ...
    it "cannot query vms via both virtual attribute and subcollection" do
      get api_service_url(nil, svc1), :expand => "vms", :attributes => "vms"
  ...
  describe "Power Operations" do
    describe "start" do
      it "will start a service for a user with appropriate role" do
        ...
        post(api_service_url(nil, service), :action => "start")
      ...
      it "can start multiple services for a user with appropriate role" do
        ...
        post(api_services_url, :action => "start", :resources => [{:id => service_1.id}, {:id => service_2.id}])
    ...
    describe "stop" do
      it "will stop a service for a user with appropriate role" do
        ...
        post(api_service_url(nil, service), :action => "stop")
      ...
      it "can stop multiple services for a user with appropriate role" do
        ...
        post(api_services_url, :action => "stop", :resources => [{:id => service_1.id}, {:id => service_2.id}])
    ...
    describe "suspend" do
      it "will suspend a service for a user with appropriate role" do
        ...
        post(api_service_url(nil, service), :action => "suspend")
      ...
      it "can suspend multiple services for a user with appropriate role" do
        ...
        post(api_services_url, :action => "suspend", :resources => [{:id => service_1.id}, {:id => service_2.id}])
  ...
  describe 'Orchestration Stack subcollection' do
    ...
    it 'can query orchestration stacks as a subcollection' do
      ...
      get(api_service_orchestration_stacks_url(nil, svc), :expand => 'resources')
    ...
    it 'can query a specific orchestration stack asking for stdout' do
      ...
      get(api_service_orchestration_stack_url(nil, svc, os), :attributes => "stdout")
    ...
    it 'can query a specific orchestration stack asking for stdout in alternate format' do
      ...
      get(api_service_orchestration_stack_url(nil, svc, os), :attributes => "stdout", :format_attributes => "stdout=json")
  ...
  describe 'add_resource' do
    ...
    it 'requires a valid resource' do
      ...
      post(api_service_url(nil, svc), request)
    ...
    it 'cannot add multiple vms to multiple services by href without an appropriate role' do
      ...
      post(api_services_url, 'action' => 'add_resource')
  ...
  describe 'remove_resource' do
    ...
    it 'cannot remove vms from services without an appropriate role' do
      ...
      post(api_services_url, 'action' => 'remove_resource')
    ...
    it 'cannot remove a vm from a service without an appropriate role' do
      ...
      post(api_service_url(nil, svc), 'action' => 'remove_resource')
  ...
  describe 'remove_all_resources' do
    ...
    it 'cannot remove all resources without an appropriate role' do
      ...
      post(api_services_url, 'action' => 'remove_all_resources')
    ...
    it 'cannot remove all resources without an appropriate role' do
      ...
      post(api_service_url(nil, svc), :action => 'remove_all_resources')
