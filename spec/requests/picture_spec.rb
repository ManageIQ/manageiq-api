...
describe "Pictures" do
  ...
  describe "Queries of Services" do
    it "allows queries of the related picture and image_href" do
      ...
      get api_service_url(nil, service), :attributes => "picture,picture.image_href"
  ...
  describe "Queries of Service Requests" do
    it "allows queries of the related picture and image_href" do
      ...
      get api_service_request_url(nil, service_request), :attributes => "picture,picture.image_href"
  ...
  describe 'POST /api/pictures' do
    ...
    it 'rejects create without an appropriate role' do
      ...
      post api_pictures_url, :extension => 'png', :content => content
    ...
    it 'creates multiple pictures' do
      ...
      expect do
        post(api_pictures_url, gen_request(:create, [
    ...
    it 'requires an extension' do
      ...
      post api_pictures_url, :content => content
    ...
    it 'requires content' do
      ...
      post api_pictures_url, :extension => 'png'
    ...
    it 'requires content with valid base64' do
      ...
      post api_pictures_url, :content => 'not base64', :extension => 'png'
