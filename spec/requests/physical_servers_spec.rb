  ...
  describe "power on/off a physical server" do
    context "with valid action names" do
      it "powers on a server successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:power_on))
      ...
      it "powers off a server successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:power_off))
      ...
      it "immediately powers off a server successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:power_off_now))
      ...
      it "restarts a server successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:restart))
      ...
      it "immediately restarts a server successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:restart_now))
      ...
      it "restarts a server to the system setup successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:restart_to_sys_setup))
      ...
      it "restarts a server's management controller" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:restart_mgmt_controller))
  ...
  describe "turn on/off a physical server's location LED" do
    context "with valid action names" do
      it "turns on a location LED successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:turn_on_loc_led))
      ...
      it "turns off a location LED successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:turn_off_loc_led))
      ...
      it "blinks a location LED successfully" do
        ...
        post(api_physical_server_url(nil, ps), gen_request(:blink_loc_led))
