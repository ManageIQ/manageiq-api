...
describe "Groups API" do
  ...
  describe "groups create" do
    it "rejects creation without appropriate role" do
      ...
      post(api_groups_url, sample_group1)
    ...
    it "rejects group creation with id specified" do
      ...
      post(api_groups_url, "description" => "sample group", "id" => 100)
    ...
    it "rejects group creation with invalid role specified" do
      ...
      post(api_groups_url, "description" => "sample group", "role" => {"id" => 999_999})
    ...
    it "rejects group creation with invalid tenant specified" do
      ...
      post(api_groups_url, "description" => "sample group", "tenant" => {"id" => 999_999})
    ...
    it "rejects group creation with invalid filters specified" do
      ...
      post(api_groups_url, "description" => "sample group", "filters" => {"bogus" => %w(f1 f2)})
    ...
    it "supports single group creation via action" do
      ...
      post(api_groups_url, gen_request(:create, sample_group1))
    ...
    it "supports single group creation via action with role and tenant specified" do
      ...
      post(api_groups_url, gen_request(:create,
    ...
    it "supports single group creation with filters specified" do
      ...
      post(api_groups_url, gen_request(:create, sample_group))
    ...
    it "supports multiple group creation" do
      ...
      post(api_groups_url, gen_request(:create, [sample_group1, sample_group2]))
  ...
  describe "groups edit" do
    it "rejects group edits without appropriate role" do
      api_basic_authorize
      post(api_groups_url, gen_request(:edit,
    ...
    it "rejects group edits for invalid resources" do
      ...
      post(api_group_url(nil, 999_999), gen_request(:edit, "description" => "updated_group"))
    ...
    it "supports single group edit" do
      ...
      post(api_group_url(nil, group1), gen_request(:edit, "description" => "updated_group"))
  ...
  describe "groups delete" do
    it "rejects group deletion, by post action, without appropriate role" do
      ...
      post(api_groups_url, gen_request(:delete, "description" => "group_description", "href" => api_group_url(nil, 100)))
    ...
    it "supports single group delete action" do
      ...
      post(g1_url, gen_request(:delete))
    ...
    it "supports multiple group deletes" do
      ...
      post(api_groups_url, gen_request(:delete, [{"href" => g1_url}, {"href" => g2_url}]))
  ...
  describe "tags subcollection" do
    ...
    it "can assign a tag to a group" do
      ...
      post(api_group_tags_url(nil, group), :action => "assign", :category => "department", :name => "finance")
    ...
    it "can unassign a tag from a group" do
      ...
      post(api_group_tags_url(nil, group), :action => "unassign", :category => "department", :name => "finance")
